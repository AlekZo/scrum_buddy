          ...
          <>
            {entry.done && (
              <div>
                ...
                <p className="text-xs font-mono text-foreground/70 whitespace-pre-wrap leading-relaxed">{entry.done}</p>
              </div>
            )}
            {entry.doing && (
              <div>
                ...
                <p className="text-xs font-mono text-foreground/70 whitespace-pre-wrap leading-relaxed">{entry.doing}</p>
              </div>
            )}
            {entry.blockers && (
              <div>
                ...
                <p className="text-xs font-mono text-foreground/70 whitespace-pre-wrap leading-relaxed">{entry.blockers}</p>
              </div>
            )}
          </>
        )}

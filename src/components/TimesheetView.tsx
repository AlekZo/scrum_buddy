      ...
      <div className="space-y-4">
        ...
        <Card className="border-border/50">
          <CardContent className="py-3 px-4">
            ...
            {!presentationMode && hasDualTotals && (
                  ...
                  <TableRow className="hover:bg-transparent border-border/50">
                     ...
                     <TableHead colSpan={2} className="text-[11px] font-semibold uppercase tracking-wider">
                       <div className="flex items-center gap-3">
                         ...
                         <span className="flex items-center gap-1"><span className="inline-block w-1.5 h-1.5 rounded-full bg-blue-500" /> Doing</span>
                          ...
                          {line.text ? (
                            <div className="flex items-center gap-1.5">
                              <span className={`inline-block w-1.5 h-1.5 rounded-full flex-shrink-0 ${
                                line.type === "done" ? "bg-emerald-500" : line.type === "doing" ? "bg-blue-500" : "bg-destructive"
                              }`} />
        ...
        {/* Task aggregation */}
        {!presentationMode && taskAggregation.length > 0 && (
          <Card className="border-border/50">
            <CardHeader className="pb-3">
